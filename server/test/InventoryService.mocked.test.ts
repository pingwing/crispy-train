...
describe('InventoryService (mocked repositories)', () => {
  it('listStores delegates to stores.list', async () => {
  ...
  it('getStore delegates to stores.getById', async () => {
  ...
  it('listInventoryItems clamps page/pageSize and defaults filter to {}', async () => {
  ...
  it('createStore trims inputs and delegates to stores.create', async () => {
  ...
  it('updateStore throws NotFoundError when stores.update returns null', async () => {
  ...
  it('updateStore trims optional fields and preserves explicit null location', async () => {
  ...
  it('createProduct trims inputs and delegates to products.create', async () => {
    const create = createAsyncSpy(async (input: any) => {
  ...
  it('upsertInventoryItem checks store/product existence and delegates to inventory.upsertInventoryItem', async () => {
  ...
  it('upsertInventoryItem throws NotFoundError when store is missing', async () => {
  ...
  it('upsertInventoryItem throws NotFoundError when product is missing', async () => {
  ...
  it('deleteInventoryItem throws NotFoundError when repository returns false', async () => {
  ...
  it('deleteInventoryItem returns true when repository returns true', async () => {
